...
class choice_container_def:public arx::referrable
{
    public:
    choice_container_def(std::shared_ptr<arx::armodel> model, const std::string& shortname, std::unique_ptr<std::string> uuid, rapidxml::xml_node<>* node);
