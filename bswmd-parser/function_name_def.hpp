...
class function_name_def:public arx::referrable
{
    public:
    function_name_def(std::shared_ptr<arx::armodel> model, const std::string& shortname, std::unique_ptr<std::string> uuid, rapidxml::xml_node<>* node);
